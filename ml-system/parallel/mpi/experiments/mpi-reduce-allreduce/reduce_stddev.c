...
int main(int argc, char** argv) {
  ...
  // Reduce all of the local sums into the global sum in order to calculate the
  // mean. MPI_Allreduce is identical to MPI_Reduce with the exception that it
  // does not need a root process id.
  float global_sum;
